...
log_dir="/mnt/dm"
bench_script=ConvolutionWorkLoad_MIOpen_1896
...
# docker exec -i $container_name bash -c "cat /tmp/host_env.log $log_dir/conv_with_env.log > $log_dir/$bench_script.log && rm -f /tmp/host_env.log $log_dir/conv_with_env.log"
